...
const TOOL_TTL = {
  ...
  get_withdrawal_fees:           3600,
  find_cheapest_withdrawal:      3600,
  get_deposit_networks:          3600,
  find_common_networks:          3600,
  compare_exchanges:             3600,
  check_coin_listed_on_exchange: 3600,
  get_exchange_supported_chains: 3600,
  get_all_exchange_coins:        3600,
  search_coin_across_exchanges:  3600,
  check_withdrawal_minimums:     3600,
  get_exchange_info:             3600,
  compare_deposit_fees:          3600,
  estimate_transfer_cost:        3600,
  plan_cross_exchange_transfer:  3600,
  find_common_networks:          3600,
  find_conversion_route:         3600,
  find_cheapest_stable_exit:     3600,
  plan_deposit_to_exchange:      3600,
